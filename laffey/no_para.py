...
def laffey_speaks():
    ...
    speak_lib = ['指挥官休息的还好吗，拉菲现在很有精神，大概','唔……还算勉勉强强吧','呣……指挥官，不要摇我……','如果我的躯体不再是这个躯体，你还会看我吗？……','嗯……我去睡个回笼觉','指挥官，我们要不要种点花呢？','指挥官不理拉菲，哈啊……都要睡着噜……','嗯？这是拉菲心情好的表现喔','拉菲并没有在让指挥官理她，嗯，并没有','拉菲并没有在引诱指挥官跟她玩，嗯，大概','指挥官指挥官，拉菲，可，怕，吗？','状态良好……去吧','指挥官，累了吗？','指挥官……莫非是变态？！','拉菲，现在，超有精神—— ','标枪，绫波，Z23……都是好朋友，想和她们，还有大家一直在一起','拉菲并没有在摆姿势引诱指挥官夸她，嗯，并没有','唔，不过保持这个状态，好累……指挥官，大腿借我，我要睡会儿Zzzzzz','被大家说虽然外表变帅了，本质却一点也没有变，这是在夸拉菲吗？']
...
def system_status():
    ...
    return ("内存占用:"+usedRam+'M/'+topRam+'M('+str(round(float((mem['MemUsed'])/int(mem['MemTotal']))*100))+'%)\n'+"负载:"+str(loadavg['lavg_1'])+' '+str(loadavg['lavg_5'])+' '+str(loadavg['lavg_15'])+"\n硬盘:"+str(int(caphd-avahd))+'M/'+str(int(caphd))+'M')
